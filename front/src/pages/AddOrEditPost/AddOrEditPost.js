...
const AddOrEditPost = (props) => {
  ...
  return (
    <form className="new-post-container" onSubmit={onSubmit}>
      ...
      <header id="create-new-post-title">
        {isNewPost ? t("addNewPostTitle") : t("editPostTitle")}
      </header>
      <div
        id="new-post-form-container"
        className={isNewPost ? "" : "edit-post-container"}
      >
        <img
          id={isNewPost ? "icon-header-new-post" : "edit-post-logo"}
          src={isNewPost ? bookSVG : editSVG}
        />
        <input
          id="input-add-title"
          type="text"
        ...
        <div className="image-addition-input">
          <label
            className={
              i18n.language === "he"
                ? "upload-pic-label upload-pic-label-hebrew"
                : "upload-pic-label"
            }
            htmlFor="upload"
          >
        ...
        ></div>
        <button className="create-post-button" type="submit" disabled={success}>
